        ...
        <footer className={styles.rodape}>
            <div className={styles.social}>
                <Link href="https://www.facebook.com/" target="_blank">
                    <Image src="/facebook.svg" alt="facebook" width={20} height={20} className={styles.icone} />
                </Link>
                <Link href="https://web.telegram.org/" target="_blank">
                    <Image src="/telegram.svg" alt="telegram" width={20} height={20} className={styles.icone} />
                </Link>
                <Link href="https://www.whatsapp.com/?lang=pt_BR" target="_blank">
                    <Image src="/whatsapp.svg" alt="whatsapp" width={20} height={20} className={styles.icone} />
                </Link>
                <Link href="https://www.tiktok.com/pt-BR/" target="_blank">
                    <Image src="/tiktok.svg" alt="tiktok" width={20} height={20} className={styles.icone} />
                </Link>
            </div>
